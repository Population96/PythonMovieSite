...
hero6 = media.Movie("Big Hero 6",
                    ...
                    ("The special bond that develops between plus-sized"
                     ...
                     " who team up with a group of friends to form a "
...
john_wick = media.Movie("John Wick",
                        ...
                        ("An ex-hitman comes out of retirement to track"
                         " down the gangsters that took everything from"
                         " him."),
                        ("https://upload.wikimedia.org/wikipedia/en/9/"
                         "98/John_Wick_TeaserPoster.jpg"),
...
anchorman = media.Movie("Anchorman: The Legend of Ron Burgundy",
                        "2004",
                        ("Ron Burgundy is San Diego's top rated newsman"
                         " in the male-dominated broadcasting of the "
                         "'70s, but that's all about to change for Ron "
                         "and his cronies when an ambitious woman is "
                         "hired as a new anchor."),
                        ("https://upload.wikimedia.org/wikipedia/en/6/"
                         "64/Movie_poster_Anchorman_The_Legend_of_Ron_"
                         "Burgundy.jpg"),
